...
ActiveRecord::Schema.define(version: 20200315222903) do
  ...
  create_table "tag_topics", force: :cascade do |t|
    ...
    t.index ["tag_name"], name: "index_tag_topics_on_tag_name"
  end

  create_table "taggings", force: :cascade do |t|
    t.string "long_url", null: false
    t.string "tag_name", null: false
    t.index ["long_url"], name: "index_taggings_on_long_url"
